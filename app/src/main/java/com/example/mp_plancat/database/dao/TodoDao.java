...
public interface TodoDao {
    ...
    List<Todo> getAllByCategoryAndDate(int day, int month, int year, String category);
    ...
    List<Todo> getAllOfNotFinishedByCategoryAndDate(int day, int month, int year, String category);
