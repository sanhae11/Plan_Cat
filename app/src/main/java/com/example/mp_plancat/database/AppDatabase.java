...
import com.example.mp_plancat.database.dao.LocationDao;
...
@Database(entities = {GameInfo.class, Goods.class, PurchasedGoods.class, Location.class, Cat.class, CollectedCat.class}, version = 2)
